...
build{
    ...
    sources={
		...
		'Utilities/LowLevelUtilities/Src/SubscribeBase.cpp',
		'Utilities/LowLevelUtilities/Src/SubscribeEXTI.cpp',
		'Utilities/LowLevelUtilities/Src/SubscribeDebounce.cpp',
